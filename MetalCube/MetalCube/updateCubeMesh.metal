...
kernel void updateCubeMesh(device CubeVertex* vertices [[buffer(0)]],
    ...
    // Calculate which face and vetext we're working with
    ...
    uint y = vertexInPlane / params.dimensions_y;
    ...
    // Proportionally normalize baased on normalization factor (0 = cube, 1 = fullt normalized)
